...
def _get_kwargs():
    ...
    parser.add_argument('--network-timeout', default=30, type=int)
    parser.add_argument('--signature-name', default='serving_default')
...
def main():
    ...
    port = kwargs['port']
    signature_name = kwargs['signature_name']
    wait_time = kwargs['network_timeout']
